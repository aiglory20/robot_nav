...
1. Follow is a configuration example for HAP LiDAR (located in config/HAP_config.json):
    ...
    For more information about the HAP config, please refer to:
...
Please check the "Global Options - Fixed Frame" field in the RViz "Display" panel. Set the field value to "livox_frame" and check the "PointCloud2" option in the panel.
