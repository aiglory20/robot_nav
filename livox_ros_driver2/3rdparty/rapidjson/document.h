...
struct IsGenericValueImpl<
  T, typename Void<typename T::EncodingType>::Type, typename Void<typename T::AllocatorType>::Type>
...
struct TypeHelper<ValueType, const typename ValueType::Ch *>
{
  ...
  static ValueType & Set(
    ValueType & v, const StringType data, typename ValueType::AllocatorType & a)
  {
 ...
 */
  ...
  */
  GenericValue & AddMember(GenericValue & name, GenericValue & value, Allocator & allocator)
  {
    ...
    if (o.size >= o.capacity)
      MemberReserve(
        o.capacity == 0 ? kDefaultObjectCapacity : (o.capacity + (o.capacity + 1) / 2), allocator);
  ...
  */
  MemberIterator EraseMember(ConstMemberIterator first, ConstMemberIterator last)
  {
    ...
    std::memmove(
      static_cast<void *>(&*pos), &*last, static_cast<size_t>(MemberEnd() - last) * sizeof(Member));
  ...
  */
  GenericValue & Reserve(SizeType newCapacity, Allocator & allocator)
  {
    ...
    if (newCapacity > data_.a.capacity) {
      SetElementsPointer(
        reinterpret_cast<GenericValue *>(allocator.Realloc(
...
public:
  ...
  */
  explicit GenericDocument(
    Type type, Allocator * allocator = 0, size_t stackCapacity = kDefaultStackCapacity,
  ...
  */
  ...
  GenericDocument & Parse(const typename SourceEncoding::Ch * str, size_t length)
  {
    RAPIDJSON_ASSERT(!(parseFlags & kParseInsituFlag));
    MemoryStream ms(
      reinterpret_cast<const char *>(str), length * sizeof(typename SourceEncoding::Ch));
...
public:
  ...
  typedef GenericMemberIterator<
    Const, typename ValueT::EncodingType,
